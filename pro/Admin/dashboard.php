...
<?php
  ...
  while($row = mysqli_fetch_array($query_run))
  {
    ?>
      <tr>
      <td><?php echo '1'//htmlentities($cnt);?></td>
      <td><?php echo '<img src="data:image;base64,' .base64_encode($row['image']).'" alt="Image" style="width: 50px; height:50px;" >';  ?></td>
      <td><?php echo $row['name']; ?></td>
      <td><?php echo $row['mobile']; ?></td>
      <td><?php echo $row['email']; ?></td>
      <td><?php echo $row['city']; ?></td>
      <td><button class="btn btn-success btn-sm edit btn-flat" data-id="<?php //echo $row['rid']; ?>"><i class="fa fa-edit"></i> Edit</button></td>
      </tr>
    <?php
  }
...
?>
                      ...
                      <?php
                                                          ...
                                                          /*   $id=$_SESSION['id'];
                    $sql = " SELECT * user where id=$";
                    $query = $conn->query($sql);$cnt=1;
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                         <td><?php echo htmlentities($cnt);?></td>
                          <td><img src="<?php echo (!empty($row['image']))? 'images/'.$row['image']:'images/profile.jpg'; ?>" width="30px" height="30px"> </td>
                          <td><?php echo $row['name']; ?></td>
                          <td><?php echo $row['mobile']; ?></td>
                            <td><?php echo $row['email']; ?></td>
                          <td><?php echo $row['username']; ?></td>
                          <td>
                            <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php //echo $row['rid']; ?>"><i class="fa fa-edit"></i> Edit</button>
