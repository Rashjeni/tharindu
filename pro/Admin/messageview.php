...
<div class="main-body">
      ...
      ?>       
                    ...
                    $sql = " SELECT * FROM `message` where  id  ORDER by id DESC";
                        ...
                        <tr>
                         <td><?php echo htmlentities($cnt);?></td>
                          ...
                          <td><?php echo date('M d, Y', strtotime($row['created_on'])) ?></td>
                             <td>
                            <button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $row['id']; ?>"><i class="fa fa-edit"></i> Reply</button>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="action/messageadmin.php"  enctype="multipart/form-data">
            		<input type="text" class="empid" name="id" hidden="">
               <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                        <h5>Send Replay Message</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Type Message</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button class="btn btn-success " style="float:right;border-radius: 30px;" type="submit"  name="edit"><i class="fas fa-check"></i> Send Reply</button>
                                    </div>
                                    </div>
                                </div>
                    </div>
